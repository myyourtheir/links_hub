...
const DialogContent = React.forwardRef<
	...
	React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { portalHost?: string } & { withoutClose?: boolean }
>(({ className, children, portalHost, withoutClose = false, ...props }, ref) => {
	const { open } = DialogPrimitive.useRootContext()
	return (
