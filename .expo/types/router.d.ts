...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(components)/AddFolderDialog` | `/(components)/AddLinkDialog` | `/(components)/OrientationContext` | `/(components)/ScrollPathArea` | `/(components)/SettingsPopover` | `/(components)/TopBar` | `/(components)/TopLayoutComponent` | `/(screens)` | `/AddFolderDialog` | `/AddLinkDialog` | `/AddingIntentScreen` | `/HomeScreen` | `/ImagePicker` | `/OrientationContext` | `/ScrollPathArea` | `/SearchScreen` | `/SelectPath/(components)/TopComponent` | `/SelectPath/TopComponent` | `/SettingsPopover` | `/SettingsScreen` | `/TopBar` | `/TopLayoutComponent` | `/_sitemap`;
  type DynamicRoutes<T extends string> = `/${CatchAllRoutePart<T>}` | `/${SingleRoutePart<T>}` | `/SelectPath/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/SelectPath/[parentId]` | `/[...unmatched]` | `/[parentId]`;
